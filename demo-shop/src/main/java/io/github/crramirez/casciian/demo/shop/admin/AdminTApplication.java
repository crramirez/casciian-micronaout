...
public class AdminTApplication extends TApplication {
    ...
    void refreshList() {
        ...
        // Micronaut Data CrudRepository.findAll() returns an Iterable, not
        // a List, so we copy into our own list before sorting.
        products.findAll().forEach(currentSnapshot::add);
