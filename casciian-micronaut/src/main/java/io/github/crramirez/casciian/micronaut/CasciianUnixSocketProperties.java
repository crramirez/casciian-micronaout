 ...
 */
@ConfigurationProperties(CasciianUnixSocketProperties.PREFIX)
public class CasciianUnixSocketProperties {

    /** Configuration prefix. */
    public static final String PREFIX = "casciian.unix-socket";
     ...
     * {@code false} so that adding the integration to an existing application
