...
import io.github.crramirez.casciian.micronaut.client.CasciianConsoleProtocol;
...
/**
 * Lifecycle-aware bean that owns a Unix-domain-socket listener serving a
 ...
 * or ArgoCD already provide an authenticated shell. The Micronaut-side
 * application binds a socket file (typically under {@code /tmp}), and the
 * tiny {@link io.github.crramirez.casciian.micronaut.client.CasciianConsoleClient CasciianConsoleClient} bundled in the same JAR connects to
